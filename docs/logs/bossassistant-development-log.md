...
- API 和 Web 已有第一版实现
- 依赖已安装，build / typecheck 通过
- `verify:smoke` 和 Playwright E2E 验证已通过
- chatbot-first 交互、SQLite 持久化、run history 已实现
- Claude 兼容 AI 增强层可选接入
...
- files: `docs/contracts/bossassistant-intent-router-contract-v1.md`
- verification: `manual`
...
- files: `docs/roadmap/bossassistant-demo-mvp-tonight-v1.md`
- verification: `manual`
...
- files: `docs/tasks/bossassistant-demo-task-breakdown-v1.md`
- verification: `manual`
...
- files: `package.json`, `tsconfig.base.json`, `.gitignore`, `apps/api/package.json`, `apps/web/package.json`, `packages/contracts/package.json`
...
- files: `packages/contracts/src/router.ts`, `packages/contracts/src/demo-run.ts`, `packages/contracts/src/index.ts`
- verification: `not run`
...
- files: `apps/api/src/index.ts`, `apps/api/src/router.ts`, `apps/api/src/planner.ts`
- verification: `not run`
...
- files: `apps/web/src/App.tsx`, `apps/web/src/main.tsx`, `apps/web/src/styles.css`, `apps/web/index.html`
- verification: `not run`
...
- files: `packages/contracts/fixtures/intent-router/meeting.json`, `packages/contracts/fixtures/intent-router/deal.json`, `packages/contracts/fixtures/intent-router/content.json`, `packages/contracts/fixtures/intent-router/unknown.json`, `packages/contracts/fixtures/intent-router/unsupported.json`, `docs/tasks/bossassistant-demo-task-breakdown-v1.md`
- verification: `manual`
...
- files: `.npmrc`, `.gitignore`, `apps/api/package.json`, `apps/api/tsconfig.json`, `apps/api/src/router.ts`, `apps/web/src/App.tsx`, `tsconfig.base.json`
...
- files: `package-lock.json`, `packages/contracts/fixtures/intent-router/content.json`, `packages/contracts/fixtures/intent-router/deal.json`, `packages/contracts/fixtures/intent-router/meeting.json`, `packages/contracts/fixtures/intent-router/unknown.json`, `packages/contracts/fixtures/intent-router/unsupported.json`, `docs/logs/bossassistant-development-log.md`
...
- files: `scripts/verify-smoke.mjs`, `docs/demo/bossassistant-demo-runbook-tonight-v1.md`, `playwright.config.ts`, `tests/e2e/demo-console.spec.ts`, `package.json`, `apps/web/package.json`, `apps/web/src/App.tsx`, `apps/web/src/styles.css`, `.gitignore`
- verification: `manual`
...
- files: `package-lock.json`, `scripts/verify-smoke.mjs`, `tests/e2e/demo-console.spec.ts`, `docs/logs/bossassistant-development-log.md`
- verification: `smoke passed`
...
- files: `apps/api/src/i18n.ts`, `apps/api/src/router.ts`, `apps/api/src/planner.ts`, `apps/api/src/index.ts`, `apps/web/src/i18n.ts`, `apps/web/src/App.tsx`, `apps/web/src/styles.css`, `docs/demo/bossassistant-demo-runbook-tonight-v1.md`, `docs/tasks/bossassistant-demo-task-breakdown-v1.md`
- verification: `manual`
...
- files: `tests/e2e/demo-console.spec.ts`, `scripts/verify-smoke.mjs`, `package-lock.json`, `docs/logs/bossassistant-development-log.md`
- verification: `smoke passed`
...
- files: `packages/contracts/src/demo-run.ts`, `apps/api/src/run-store.ts`, `apps/api/src/index.ts`, `apps/web/src/App.tsx`, `apps/web/src/i18n.ts`, `apps/web/src/styles.css`, `playwright.config.ts`, `.gitignore`, `docs/tasks/bossassistant-demo-task-breakdown-v1.md`
- verification: `build passed`
...
- files: `scripts/verify-smoke.mjs`, `tests/e2e/demo-console.spec.ts`, `playwright.config.ts`, `docs/logs/bossassistant-development-log.md`
- verification: `smoke passed`
...
- files: `apps/api/src/ai.ts`, `apps/api/src/index.ts`, `docs/logs/bossassistant-development-log.md`
- verification: `build passed`
...
- files: `packages/contracts/src/demo-run.ts`, `apps/api/src/ai.ts`, `apps/api/src/index.ts`, `apps/web/src/App.tsx`, `apps/web/src/i18n.ts`, `apps/web/src/styles.css`
- verification: `build passed`
...
- files: `tests/e2e/demo-console.spec.ts`, `playwright.config.ts`, `package.json`, `docs/logs/bossassistant-development-log.md`
- verification: `smoke passed`
