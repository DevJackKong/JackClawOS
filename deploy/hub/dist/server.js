...
function createServer() {
    ...
    app.post('/api/register', security_1.rateLimiter.register, register_1.default);
    ...
    app.post('/api/humans/message', humans_1.default);
    ...
    app.use('/health', health_1.protectedHealthRouter);
    ...
    app.use('/api', learning_1.default); // skills library + reflexion
